	...
	<div id="content">
		...
		<div id="carousel">
			<div id="myCarousel" class="carousel slide">
				...
				<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/afis3.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/afis4.jpg" class="carousel"></div>
				<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/afis6.jpg" class="carousel"></div>
				</div>
		...
		<div id="product" style="position:relative; margin-top:30%;">
			<center><h2><legend></legend></h2></center>
			<br />
